...
mkdir -p data && python generate_synthetic_data.py --problem 2d_rot4
mkdir -p data && python generate_synthetic_data.py --problem rank2_kernel5
mkdir -p data && python generate_synthetic_data.py --problem rank5_kernel5